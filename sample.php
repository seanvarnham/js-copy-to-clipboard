<div data-sticky="" class="<?php echo implode(" ", $classes) ?>">
    ...
    <div data-event="share" class="click-event__share email">
        <a tabindex="-1" href="mailto:?subject=<?php the_title(); ?>&amp;body=I thought you would be interested in this story from The Global Warming Policy Foundation:%0D%0A%0D%0A<?php the_title(); ?>%0D%0A%0D%0A<?php the_permalink(get_the_ID()); ?>" class="single__widget-link">
